    ...
    <div className="router-ctn">
      <div className="ds-view-ctn">
        <div className="punter-view" id="main-content">
          <div className="sports-view-ctn horse-greyhound">
            <div
              _ngcontent-wne-c149=""
            ...
            >
              <div
                _ngcontent-wne-c149=""
                className="horse-greyhound-card m-1"
                style={{
                  borderRadius: "2px",
              ...
              >
                <div
                  _ngcontent-wne-c149=""
                  className="horse-greyhound-card-header"
                >
                  <div
                    _ngcontent-wne-c149=""
                  ...
                  >
                    <div _ngcontent-wne-c149="" className="p-1">
                      <span
                        _ngcontent-wne-c149=""
                        className="match_card_heading horse-racing-heading"
                      >
                        {title}
                      </span>
                    </div>
                          ...
                          <div _ngcontent-wne-c149="" className="col-md-10">
                            {child?.childs?.map((item) => {
                              return (
                                <span
                                  onClick={() =>
                                    navigate(`/${eventTypeId}/${item?.eventId}`)
                                  }
                                  key={item?.eventId}
                                  _ngcontent-wne-c149=""
                                  className="ng-star-inserted"
